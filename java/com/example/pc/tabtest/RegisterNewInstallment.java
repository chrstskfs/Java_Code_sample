...
public class RegisterNewInstallment extends ActionBarActivity implements View.OnClickListener {
    ...
    private AsyncTasRegisterNewInstallment myAsyncTask;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_register_new_installment);
        ...
        this.location = (EditText)findViewById(R.id.newInstallationLocation);
        this.okButton = (Button)findViewById(R.id.regNewInstallationButton);
        ...
        this.myBar = (ProgressBar)findViewById(R.id.progressbar_for_new_instalment);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_register_new_installment, menu);
        return true;
    }
    ...
    public void onClick(View v) {
        ...
        myAsyncTask = new AsyncTasRegisterNewInstallment();
    ...
    private class AsyncTasRegisterNewInstallment extends AsyncTask<String, Integer, String>{
